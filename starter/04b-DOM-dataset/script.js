...
const stock = document.getElementById('xs-max').dataset.stock;

console.log(`J'ai ${stock} iPhone(s) XS Max en stock`);

document.querySelector('ul').insertAdjacentHTML('afterend',`<p>J'ai ${stock} iPhone(s) XS Max en stock</p>`);